# Generated by Django 4.2.11 on 2024-03-09 06:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ebook',
            name='level',
            field=models.ForeignKey(help_text='for refer level like(begineers,advanced)', on_delete=django.db.models.deletion.CASCADE, to='Learn.level'),
        ),
        migrations.CreateModel(
            name='Dislike',
            fields=[
        ...
        migrations.AddField(
            ...
            name='section',
            field=models.ForeignKey(help_text='for refer to which course section related', on_delete=django.db.models.deletion.CASCADE, to='Learn.section'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='course',
            name='creator',
            field=models.ForeignKey(help_text='for course creator', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Certificate',
            fields=[
